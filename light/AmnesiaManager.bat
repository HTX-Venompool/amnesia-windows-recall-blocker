...
echo if exist "%%%%d\ImageStore" (rd /s /q "%%%%d\ImageStore" ^> nul) >> "%installpath%Amnesia.bat"
echo if exist "%%%%d\ukg.db" (del /s /f /q "%%%%d\ukg.db" ^> nul) >> "%installpath%Amnesia.bat"
echo if exist "%%%%d\ukg.db-shm" (del /s /f /q "%%%%d\ukg.db-shm" ^> nul) >> "%installpath%Amnesia.bat"
echo if exist "%%%%d\ukg.db-wal" (del /s /f /q "%%%%d\ukg.db-wal" ^> nul) >> "%installpath%Amnesia.bat"
echo if exist "%%%%d\SemanticImageStore.sidb" (del /s /f /q "%%%%d\SemanticImageStore.sidb" ^> nul) >> "%installpath%Amnesia.bat"
echo if exist "%%%%d\SemanticImageStore.sidb.lock" (del /s /f /q "%%%%d\SemanticImageStore.sidb.lock" ^> nul) >> "%installpath%Amnesia.bat"
echo if exist "%%%%d\SemanticImageStore.sidb-shm" (del /s /f /q "%%%%d\SemanticImageStore.sidb-shm" ^> nul) >> "%installpath%Amnesia.bat"
echo if exist "%%%%d\SemanticImageStore.sidb-wal" (del /s /f /q "%%%%d\SemanticImageStore.sidb-wal" ^> nul) >> "%installpath%Amnesia.bat"
echo if exist "%%%%d\SemanticTextStore.sidb" (del /s /f /q "%%%%d\SemanticTextStore.sidb" ^> nul) >> "%installpath%Amnesia.bat"
echo if exist "%%%%d\SemanticTextStore.sidb.lock" (del /s /f /q "%%%%d\SemanticTextStore.sidb.lock" ^> nul) >> "%installpath%Amnesia.bat"
echo if exist "%%%%d\SemanticTextStore.sidb-shm" (del /s /f /q "%%%%d\SemanticTextStore.sidb-shm" ^> nul) >> "%installpath%Amnesia.bat"
echo if exist "%%%%d\SemanticTextStore.sidb-wal" (del /s /f /q "%%%%d\SemanticTextStore.sidb-wal" ^> nul) >> "%installpath%Amnesia.bat"
